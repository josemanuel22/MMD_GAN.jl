...
hyperparameters = HyperParamsMMD(
...
"""
train_mmd_gan(enc, dec, gen, hparams::HyperParamsMMD)

Train an MMD GAN using the specified encoder, decoder, and generator models, along with the provided hyperparameters.

# Arguments
- `enc`: The encoder neural-network model.
- `dec`: The decoder neural-network model.
- `gen`: The generator neural-network model.
- `hparams::HyperParamsMMD`: Hyperparameters for the MMD GAN training.
...
"""
function train_mmd_gan(enc, dec, gen, hparams::HyperParamsMMD)
...
export train_mmd_gan, HyperParamsMMD
